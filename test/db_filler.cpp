...
int main(int argc, char** argv)
{
    ...
    if (!short_table.empty())
        createTable(opts, short_table, bulk_size, bulk_count,
               ...
               "banner_template_id int NOT NULL DEFAULT 0,\n"
               "PRIMARY KEY (id)\n"
               ")",

               "INSERT IGNORE INTO " + short_table + "(user_id, banner_template_id) VALUES",
               "(1, 2)",
    ...
    if (!long_table.empty())
        createTable(opts, long_table, bulk_size, bulk_count, "CREATE TABLE " + long_table + "(\n"
               ...
               "cpm_limit int NOT NULL DEFAULT 0,\n"
               "block_cpm_limit int NOT NULL DEFAULT 0,\n"
               "a_block_cpm_limit int NOT NULL DEFAULT 0,\n"
               ...
               "marketing_min_share DOUBLE NOT NULL DEFAULT 1.0,\n"
               ...
               "INSERT IGNORE INTO " + long_table + "(alias, settings) VALUES",
